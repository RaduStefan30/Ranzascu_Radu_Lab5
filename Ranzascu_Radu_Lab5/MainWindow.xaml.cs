...
namespace Ranzascu_Radu_Lab5
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            Ranzascu_Radu_Lab5.PhoneNumbersDataSet phoneNumbersDataSet = ((Ranzascu_Radu_Lab5.PhoneNumbersDataSet)(this.FindResource("phoneNumbersDataSet")));
